package com.atreeon.flutter_foreground_task.models

import android.content.Context
import com.atreeon.flutter_foreground_task.PreferencesKey as PrefsKey

data class ForegroundServiceStatus(val action: String) {
    companion object {
        fun getData(context: Context): ForegroundServiceStatus {
            val prefs = context.getSharedPreferences(
                PrefsKey.FOREGROUND_SERVICE_STATUS_PREFS_NAME, Context.MODE_PRIVATE)
